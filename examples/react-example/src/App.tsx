import ImageKitEditor, {ImageKitEditorProps} from "imagekit-editor";
...
function App() {
  ...
  useEffect(() => {
    setEditorProps({
      ...
      imageUrl: "https://ik.imagekit.io/n8ym6wilmq/car.jpg",
      ...
      ikClientOptions: {
        ...
        urlEndpoint: "https://ik.imagekit.io/n8ym6wilmq",
      },
  ...
  return (
    <>
      <button onClick={() => toggle()}>Open ImageKit Editor</button>
